...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("高级筛选")])], 1)], 1), _vm._v(" "), _c('el-card', {
  ...
  }, [_vm._v("合计充值金额")]), _vm._v(" "), _c('div', {
    staticClass: "bottom clearfix"
  }, [_c('div', {
    staticClass: "card_detail"
  }, [_vm._v("￥" + _vm._s(_vm.totalMoney))])])])]), _vm._v(" "), _c('el-table', {
    staticStyle: {
      "width": "100%",
      "padding-top": "10px",
      "margin-top": "10px"
...
var update = __webpack_require__(69)("554cc5e4", content, true);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.$fetch('user/member_list?levelType=' + typeId + '&staffPosition=' + positionId + '&phone=' + this.phoneNum + '&provinceId=' + provinceId + '&cityId=' + cityId + '&start=' + (this.currentPage - 1) * 10 + '&length=10').then(data => {
        console.log(data);
...
// module
exports.push([module.i, ".card_Pink[data-v-19454dff]{background-color:#ff9997;border-radius:5px;padding:10px}.card_Green[data-v-19454dff]{background-color:#79d4cc;border-radius:5px;padding:10px}.card_Light_Green[data-v-19454dff]{background-color:#7cd96a;border-radius:5px;padding:10px}.card_Light_Blue[data-v-19454dff]{background-color:#88aedf;border-radius:5px;padding:10px}.card_Light_purple[data-v-19454dff]{background-color:#eaa5d5;border-radius:5px;padding:10px}.card_Light_blue1[data-v-19454dff]{background-color:#9be3ee;border-radius:5px;padding:10px}.card_icon[data-v-19454dff]{font-size:25px;color:#fff;padding-bottom:20px}.card_detail[data-v-19454dff]{margin-top:20px;color:#fff;font-size:20px}.dashboard-editor-container[data-v-19454dff]{padding:32px;background-color:#f0f2f5;position:relative;.github-corner{position:absolute;top:0;border:0;right:0}.chart-wrapper{background:#fff;padding:16px 16px 0;margin-bottom:32px}}@media (max-width:1024px){.chart-wrapper[data-v-19454dff]{padding:8px}}", ""]);
